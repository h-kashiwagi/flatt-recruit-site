...
def create():
    ...
    occupation_id = request.form.get('occupation_id', type=int)
    work_location = request.form.get('work_location')
    job_role = request.form.get('job_role')
    ideal = request.form.get('ideal')
    anuual_income = request.form.get('anuual_income')
    monthly_income = request.form.get('monthly_income')
    url = request.form.get('url')
    capital = request.form.get('capital', type=int)
...
# def ajax():
#     companydata = Company.getAll()
#     return jsonify(getByList(companydata))
